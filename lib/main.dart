...
import 'package:projecho/pages/enternumber.dart';
...
import 'package:projecho/pages/homefeed/menu/privacy_policy.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/comment': (context) => const CommentScreen(postId: 0), // Replace if needed dynamically
